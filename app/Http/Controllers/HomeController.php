...
class HomeController extends Controller
{
    ...
    public function redirect()
    {
        ...
        if ($usertype == '1') {
            ...
            $total_deliverd = order::where('delivery_status', '=', 'delivered')
                ->get()->count();
    ...
    public function add_cart(Request $request, $id)
    {
        if (Auth::id()) {
            ...
            if ($product_exist_id) {
                ...
                $cart->save();
                Alert::success('PC Added Successfully','We have added pc to the cart');
    ...
    public function stripePost(Request $request, $totalprice)
    {
        ...
        // dòng này báo lỗi k sao , vẫn chạy đc , nên đừng sửa gì
